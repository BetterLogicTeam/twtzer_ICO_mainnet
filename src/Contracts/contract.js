export const contractadress = "0x5Ba1C02Ebc5Ff22F4e5827fB6b5C337Ef05Efc68";
export const contractabi = [
  {
    inputs: [
      { internalType: "contract IBEP20", name: "_token", type: "address" },
      { internalType: "address payable", name: "mainAddress", type: "address" },
    ],
...
// export const tokencontractadress = "0x948b2e1F5E2Ed40AbABfB77029AF73717356fb47";
